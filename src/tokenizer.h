...
typedef enum {
	...
	// identifiers
	TOKEN_VAR, TOKEN_FOR, TOKEN_LET, TOKEN_ARROW_FUNC, TOKEN_FUNCTION,
	TOKEN_RETURN, TOKEN_CATCH, TOKEN_IF, TOKEN_ELSE, TOKEN_DO,
	TOKEN_WHILE,TOKEN_THROW,TOKEN_CONST, TOKEN_TYPEOF, TOKEN_VARIABLE,
} tokentype;
