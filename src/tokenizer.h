...
typedef enum {
	...
	TOKEN_BITSHIFT_LEFT, TOKEN_BITSHIFT_LEFT_ASSIGN,
	...
	TOKEN_LINE_COMMENT, TOKEN_MULTI_LINE_COMMENT, TOKEN_DIVIDE_ASSIGN, TOKEN_DIVIDE,
	TOKEN_EXPONENT, TOKEN_MULTIPLY_ASSIGN, TOKEN_MULTIPLY,
