...
typedef enum {
	...
	TOKEN_LINE_COMMENT, TOKEN_MULTI_LINE_COMMENT, TOKEN_DIVIDE_ASSIGN,
	TOKEN_DIVIDE, TOKEN_EXPONENT, TOKEN_MULTIPLY_ASSIGN, TOKEN_MULTIPLY,
	TOKEN_MOD_EQUAL, TOKEN_MOD, TOKEN_BITWISE_XOR, TOKEN_BITWISE_XOR_ASSIGN,
